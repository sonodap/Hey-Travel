...
users = User.create!(
  [
    ...
    {email: 'Michael@example.com', name: 'マイケル', password: 'password', image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample_icon6.jpg"), filename:"sample-_icon6.jpg")}
  ]
)
...
Post.create!(
  [
    ...
    {title: 'バスで那須にイチゴ狩り', image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample_post2.jpg"), filename:"sample_post2.jpg"),prefectures_genre: Post.prefectures_genres["tochigi"], spot_genre_id: spot_genres[1].id, post_text: '今年もバスで栃木の那須にイチゴ狩りへ行けました、美味しかったです！', user_id: users[0].id },
    ...
    {title: '富士山の写真', image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample_post4.jpg"), filename:"sample_post4.jpg"),prefectures_genre: Post.prefectures_genres["shizuoka"], spot_genre_id: spot_genres[5].id, post_text: '今年も富士山に雪が積もりました。', user_id: users[0].id },
    ...
    {title: '阿蘇山に登ってきました', image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample_post6.jpg"), filename:"sample_post6.jpg"),prefectures_genre: Post.prefectures_genres["kumamoto"], spot_genre_id: spot_genres[4].id, post_text: '天気もよく、とても見晴らしが良く楽しかったです。', user_id: users[0].id },
    ...
    {title: '猫の花見', image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample_post10.jpg"), filename:"sample_post10.jpg"),prefectures_genre: Post.prefectures_genres["tokyo"], spot_genre_id: spot_genres[5].id, post_text: '都内の桜を見に行ったら猫もお花見をしていました。', user_id: users[0].id },
    {title: '登山', image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample_post10.jpg"), filename:"sample_post6.jpg"),prefectures_genre: Post.prefectures_genres["shizuoka"], spot_genre_id: spot_genres[4].id, post_text: '登山をしに行きました、険しい山でした。', user_id: users[0].id },
    {title: 'バスでイチゴ狩り', image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample_post2.jpg"), filename:"sample_post2.jpg"),prefectures_genre: Post.prefectures_genres["saitama"], spot_genre_id: spot_genres[1].id, post_text: '今年もバスでイチゴ狩りへ行けました、美味しかったです！', user_id: users[2].id },
    {title: '山梨県側から見た富士山', image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample_post4.jpg"), filename:"sample_post4.jpg"),prefectures_genre: Post.prefectures_genres["yamanashi"], spot_genre_id: spot_genres[5].id, post_text: '山梨県から見た富士山です', user_id: users[0].id },
  ]
)
