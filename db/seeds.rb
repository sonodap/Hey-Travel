...
Post.create!(
  [
    ...
    {title: '富士山の写真', image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample_post4.jpg"), filename:"sample_post4.jpg"),prefectures_genre: Post.prefectures_genres["shizuoka"], spot_genre_id: spot_genres[4].id, post_text: '今年も富士山に雪が積もりました。', user_id: users[0].id },
    ...
    {title: '山梨県側から見た富士山', image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample_post4.jpg"), filename:"sample_post4.jpg"),prefectures_genre: Post.prefectures_genres["yamanashi"], spot_genre_id: spot_genres[4].id, post_text: '山梨県から見た富士山です', user_id: users[0].id },
  ]
)
